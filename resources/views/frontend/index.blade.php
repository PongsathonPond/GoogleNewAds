        ...
        <div class="swiper-wrapper">
            @foreach ($latest_posts as $latest_post_item)
                <div class="swiper-slide text-center"
                    data-slide-bg="{{ asset('uploads/posts/' . $latest_post_item->image) }}">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-6">
                                <div class="swiper-slide-caption">
                                    <h3 data-caption-animate="fadeInUp" data-caption-delay="100">
                                        {{ $latest_post_item->name }}</h3>
                                    <a class="button button-primary" data-caption-animate="fadeInUp"
                                        data-caption-delay="300"
                                        href="{{ url('tutorial/' . $latest_post_item->category->slug . '/' . $latest_post_item->slug) }}">Read
                                        More</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <article class="post-future">
                                        <a class="post-future-figure" href="{{ url('tutorial/' . $all_cate_item->slug) }}">
                                            <div class="col-md mt-3 mb-3">
                                                <div class="text-center ">
                                                    <img src="{{ asset('uploads/category/' . $all_cate_item->image) }}"
                                                        alt="" width="368" height="287" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="post-future-main">
                                            <h4 class="post-future-title">
                                                <a
                                                    href="{{ url('tutorial/' . $all_cate_item->slug) }}">{{ $all_cate_item->name }}</a>
                                            </h4>
                                            ...
                                            <div class="post-future-footer group-flex group-flex-xs">
                                                <a class="button button-gray-outline"
                                                    href="{{ url('tutorial/' . $all_cate_item->slug) }}">Read more</a>
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside">
                                            <a class="post-classic-figure"
                                                ...
                                                <img src="{{ asset('uploads/posts/' . $latest_post_item->image) }}"
                                                    alt="img" width="94" height="94" />
                                            </a>
                                        </div>
                                        <div class="post-classic-main">
                                            ...
                                            <div class="post-classic-time"><span class="icon mdi mdi-clock"></span>
                                                <time>Posted On:
                                                    {{ $latest_post_item->created_at->format('d-m-Y') }}</time>
                                            </div>
                                        </div>
                                    </article>
                                @endforeach
